        ...
        <section id="home" class="section active">
            <div class="container">
                <div class="hero">
                    ...
                    <a href="customerDashboard.php" class="btn btn-primary">Place Order Now</a>
                </div>
        ...
        <section id="contact" class="section">
            <div class="container">
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card">
                        <h3>Get Quote</h3>
                        <p>To request a quotation, please register or sign in to your account and use the Quotation feature available in your dashboard.</p>
                    </div>
                </div>
            </div>
        </section>
