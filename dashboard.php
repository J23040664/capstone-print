...
<body>
    ...
    <div id="sidebar" class="sidebar d-flex flex-column p-3">
        <div class="s_logo fs-5">
            <img src="./assets/icon/shoplogo.png" alt="Logo">
        </div>
        <hr />
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="quotationlist.html" class="nav-link"><i class="bi bi-question-circle"></i><span>Manage Quotation</span></a>
            </li>
        </ul>
    </div>
